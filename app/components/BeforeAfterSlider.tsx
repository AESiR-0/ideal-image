    ...
    <div className="bg-white max-md:py-10 py-16 relative">
      ...
      <h2 className="text-center text-3xl font-Begum font-bold text-[#424e6d] mb-8">
        {page === "coolsculpting-elite" ? (
          <>
            CoolSculpting® Elite <br /> Before and After
          </>
        ) : page === "coolsculpting" ? (
          <>
            CoolSculpting® <br /> Before and After
          </>
        ) : (
            ...
            <div className="flex flex-col max-md:px-10 md:flex-row justify-center items-center gap-8">
              ...
              <div className="relative">
                <Image
                  ...
                  height={300}
                />
                <div className="absolute bottom-3 left-1/2 transform -translate-x-1/2 bg-[#0A5346] text-white text-lg px-4 py-1 rounded-full">
                  BEFORE
                </div>
              </div>
              {/* After Image */}
              <div className="relative">
                ...
                <div className="text-[#424e6d] text-center pt-5">{image.text}</div>
              </div>
            </div>
          </SwiperSlide>
        ))}
