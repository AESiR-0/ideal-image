        ...
        <div className="bg-[#f6f4f2] text-secondary p-8 md:p-16 relative mt-[6vh] md:mt-[2vh] lg:mt-2">
            ...
            <div className="relative z-10 max-w-7xl mx-auto ">
                ...
                <p className="text-base font-thin md:text-lg mb-6 mx-auto leading-relaxed">
                    {page === 'coolsculpting-elite' ? 'CoolSculpting® Elite' : 'CoolSculpting®'} uses patented cooling technology to eliminate fat cells – without surgery or downtime.
                ...
                <p className="text-base font-thin md:text-lg mx-auto leading-relaxed">
                    ...
                    {page === 'coolsculpting-elite' ? 'CoolSculpting® Elite' : 'CoolSculpting®'} targets these areas to provide noticeable and lasting results, helping you look and feel your very best.
