...
const Comparison: React.FC = () => {
    return (
        <div className="bg-[#f9fafb] flex justify-center p-6 md:p-12 rounded-lg shadow-lg">
            <div className="w-[75vw]">
                ...
                <div className="space-y-8 md:space-y-0 md:grid md:grid-cols-2 gap-8">
                    ...
                    <div className="py-6 rounded-lg   bg-gray-50">
                        ...
                        <p className="text-[#3f4e6e] text-xl pr-10 leading-relaxed">
                        ...
                        <p className="mt-4 text-[#3f4e6e] text-xl pr-10 leading-relaxed">
