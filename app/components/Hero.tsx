...
import hero from "@/public/static/hero/poloroid.webp";
...
const HomeForm = () => {
  ...
  return (
    <div className="relative h-full font-sans">
      {/* Row 1: Hero Image */}
      <div className="h-[60vh] max-md:h-[30vh] flex justify-center max-md:bg-center max-md:bg-[#947458] bg-[#876747] max-md:bg-cover  static bg-contain bg-left  bg-no-repeat bg-[url('/static/hero/cactus.avif')]">
        {/* <Image
