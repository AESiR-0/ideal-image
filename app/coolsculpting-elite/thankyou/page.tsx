    ...
    <div className="min-h-screen bg-[#f6f4f2] flex items-center justify-center p-6">
      <div className="max-w-3xl w-full bg-white shadow-lg rounded-lg p-8 text-center">
        ...
        <p className="text-lg text-[#515b7e] mb-6">
          You're just one step away from your CoolSculpting® Elite
          transformation!
        </p>

        <p className="text-lg text-[#515b7e] font-medium mb-4">
          Our CoolSculpting® Elite specialists will be reaching out to you
          shortly. If you miss our call, feel free to text or email us back.
        </p>
        ...
        <div className="bg-[#0A5346] text-white p-6 rounded-lg mb-6">
          ...
          <p className="text-lg">
            Get an <strong>additional $500 off</strong> your CoolSculpting®
            Elite treatment by scheduling your consultation today!
          </p>
        </div>
        ...
        <div className="text-left space-y-4">
          ...
          <div className="flex items-start space-x-4">
            ...
            <p className="text-[#515b7e]">
              ...
              CoolSculpting® Elite treatment plan.
            </p>
          </div>
          <div className="flex items-start space-x-4">
            <span className="text-[#0A5346] font-bold">✔</span>
          ...
          <div className="flex items-start space-x-4">
            ...
            <p className="text-[#515b7e]">
              ...
              start your CoolSculpting® Elite journey the same day as your
              consultation.
            </p>
          </div>
        </div>
